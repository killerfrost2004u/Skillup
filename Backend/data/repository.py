...
class UserRepository:
    ...
    def get_by_email(self, email):
        return self.db.execute_query("SELECT * FROM Users WHERE LOWER(email)=LOWER(%s)", (email,), fetch_one=True)
    ...
    def update_password(self, user_id, hashed_password):
        return self.db.execute_query("UPDATE Users SET password=%s WHERE user_id=%s", (hashed_password, user_id))
...
class CourseRepository:
    ...
    def get_all(self):
        return self.db.execute_query("SELECT * FROM Courses", fetch_all=True)
